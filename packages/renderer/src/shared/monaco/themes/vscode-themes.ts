...
const vsDarkTheme: ThemeRegistrationResolved = {
...
export default {
  "vscode-dark": vsDarkTheme,
  "vscode-dark-plus": {
    ...vsDarkTheme,
    name: "Dark+",
    tokenColors: [
      ...vsDarkTheme.tokenColors,
      {
    ...
    semanticTokenColors: {
      ...vsDarkTheme.semanticTokenColors,
      newOperator: "#C586C0",
      stringLiteral: "#ce9178",
...
} satisfies Record<string, ThemeRegistrationResolved>;
